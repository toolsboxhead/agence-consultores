        ...
        <div class="row m-2  d-flex justify-content-center p-3">
            ...
            <div class="col-2  d-flex ">
                <div class="buttons align-self-center">
                    <input type="button" class="btn btn-dark btn-sm" value="Relatório" id="tabla" />
                    <input type="button" class="btn btn-dark btn-sm" value="Gráfico" id="g-bar" />
                    <input type="button" class="btn btn-dark btn-sm" value="Pizza" id="g-area" />
                </div>
            </div>
